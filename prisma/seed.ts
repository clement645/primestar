...
const GUIDE_ARTICLES: { section: string; title: string; content: string }[] = [
  ...
  // Crop Management
  {
    ...
    title: "Primestar's Tested One-Acre Potato Farming Procedure",
    content: `This is Primestar's own field-tested planting-to-harvest procedure for one acre of Shangi potatoes, based on several years of results on our farms. It is our recommended approach, especially for first-time farmers — you are free to adapt it to your own conditions, but we advise following it closely if you are just starting out.\n\n1. Furrows (Mtaro)\nDig your furrows about 80cm wide from one furrow to the next. On virgin land (kitira), widen this to about 1 metre.\n\n2. Seed Spacing\nPlant seeds about 25cm apart, seed to seed. A simple field trick: this is roughly the length from the back of your foot to the front of your foot when standing on the furrow — useful for explaining spacing to farm helpers who are new to potato farming.\n\n3. Fertilizer at Planting\nApply 4 bags of DAP 18:46:0 fertilizer per acre at planting, and cover it well with soil.\n\n4. Earthing Up (Kuweka Mchanga)\nStart earthing up around 3 weeks after sprouting. If some plants are still short, go ahead and earth up anyway — well-fed potato plants will still push through the soil and shoot up, and this saves you from having to repeat the process later.\n\n5. Fungicide Program\nOnce you have reasonable foliage (vegetative growth), begin a fungicide program and adjust frequency to the season:\n- Rainy, cold season: apply every 7-10 days.\n- Dry, warm months: apply every 10-14 days.\nFungicides Primestar has tested and recommends: Twigalaxy 720WP, Ridomil, Mistress, and Infinito (Infinito is recommended specifically during very rainy, humid conditions due to its high efficiency). Other fungicides exist, but this list reflects what we have used successfully for several years.\n\n6. Foliar Fertilizer\nIf you notice poor foliage or weak stems before flowering, apply a foliar fertilizer. We recommend YaraVita liquid foliar based on our own use, though other foliar products can also work.\n\n7. Pest Control Near Maturity\nIf your potatoes are maturing during the dry season, apply pesticides to protect ready tubers from cutworms — a common cause of major losses at this stage. Duduthrin or Pentagon can be applied when necessary.\n\nThese are Primestar's own recommendations based on our experience and successful results. You are not obliged to follow them exactly, but we strongly advise doing so, especially if this is your first time growing potatoes. As with any fungicide or pesticide, always follow the current approved product label and local regulations, and seek qualified agricultural advice for your specific situation.\n\nWe wish you well in your farming journey, and look forward to hearing a successful story from you.\n\nSigned and approved — Primestar Potato Seeds.`,
  },
  {
    section: "crop-management",
